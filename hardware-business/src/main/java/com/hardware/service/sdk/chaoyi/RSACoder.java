...
public class RSACoder {
    ...
    private static final String default_key = "MFwwDQYJKoZIhvcNAQEBBQADSwAwSAJBAJQeFrVhmHoWYNwPkXFVScpdwsZ/BnVhsUuGGvozfgcyde6Q7nFaTmvNBGuxbSqsSmatQLKEZWkPDDzP/Yv7zPcCAwEAAQ==";
    ...
    public static void main(String[] args) throws Exception {
    	System.out.println(genAccessToken("joy000001"));
    }
    
    /*
     * 生成 AccessToken
     */
    public static String genAccessToken(String client_id){
    	try{
    		String inputStr = String.format("{'client_id':'%s','datetime':'%s'}", client_id,
            		new SimpleDateFormat("yyyyMMddHHmmss").format(System.currentTimeMillis()));
            //System.err.println("加密前: " + inputStr);
            byte[] data = inputStr.getBytes();
            byte[] encodedData = RSACoder.encryptByPublicKey(data, default_key);
            String access_token = encryptBASE64(encodedData).replace("%", "%25").replace("&", "%26");
